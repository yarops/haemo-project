...
// Don't duplicate me!
if( !class_exists( 'ReduxFramework_extension_multi_textarea' ) ) {


    /**
     * Main ReduxFramework multi_textarea extension class
     *
     * @since       3.1.6
     */
    class ReduxFramework_extension_multi_textarea {

        // Set the version number of your extension here
        public static $version       = '1.0.0';

        // Set the name of your extension here
        public $ext_name             = 'Multi textarea';
        ...
        */
        public function __construct( $parent ) {
            ...
            $this->field_name = 'multi_textarea';
